<h1 align="center"> Resolvendo Códigos em Python com AI </h1>

<p align="center">Aqui veremos algumas resoluções de códigos em python utilizando o Github Copilot ou similares.</p>

### Atenção ⚠️ 

Resolução de desafio do curso de Github, proposto por [Aline Antunes](https://github.com/alinealien/resolvendo-codigos-py-copilot), via plataforma da Digital Innovation One (DIO).
